...
light_types["HomeAssistant-RGB"] = {"type": "Extended color light", "swversion": "5.130.1.30000", "manufacturername": "Signify Netherlands B.V.", "modelid" : "LCT007"}
light_types["HomeAssistant-RGB"]["state"] = {"on": False, "bri": 254, "hue": 0, "sat": 0, "xy": [0.0, 0.0], "alert": "none", "effect": "none", "colormode": "xy", "reachable": True}
light_types["HomeAssistant-RGB"]["config"] = {"archetype": "sultanbulb", "function": "mixed", "direction": "omnidirectional"}
light_types["HomeAssistant-RGB"]["capabilities"] = {"certified": True,"control": {"colorgamut": [[0.6915,0.3083],[0.17,0.7],[0.1532,0.0475]],"colorgamuttype": "C","ct": {"max": 500,"min": 153},"maxlumen": 800,"mindimlevel": 1000},"streaming": {"proxy": False,"renderer": True}}

# TODO fix this
light_types["HomeAssistant-WhiteAmbiance"] = {"type": "Extended color light", "swversion": "1.46.13_r26312", "manufacturername": "Home Assistant"}
light_types["HomeAssistant-WhiteAmbiance"]["state"] = {"on": False, "bri": 254, "hue": 0, "sat": 0, "xy": [0.0, 0.0], "alert": "none", "effect": "none", "colormode": "xy", "reachable": True}
light_types["HomeAssistant-WhiteAmbiance"]["config"] = {"archetype": "sultanbulb", "function": "mixed", "direction": "omnidirectional"}

light_types["HomeAssistant-Dimmable"] = {"type": "Dimmable light", "swversion": "1.46.13_r26312", "manufacturername": "Home Assistant"}
light_types["HomeAssistant-Dimmable"]["state"] = {"on": False, "bri": 254,"alert": "none", "reachable": True}
light_types["HomeAssistant-Dimmable"]["config"] = {"archetype": "classicbulb", "function": "mixed", "direction": "omnidirectional"}

light_types["HomeAssistant-Switch"] = {"type": "On/Off plug-in unit", "swversion": "V1.04.12", "manufacturername": "Home Assistant"}
light_types["HomeAssistant-Switch"]["state"] = {"on": False, "alert": "none", "reachable": True}
light_types["HomeAssistant-Switch"]["config"] = {"archetype": "classicbulb", "function": "mixed", "direction": "omnidirectional"}
